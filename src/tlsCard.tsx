...
/** Canonical TLS directory; readable by the charontak system user. */
export const TLS_DIR = '/etc/charontak/tls';

const KEY_USER = 'charontak';
            ...
            <CardExpandableContent>
                <CardBody>
                    <p>
                        ...
                        {'. '}
                        {_('With a lane open in the editor, installed paths are filled into its TLS fields.')}
                    </p>
